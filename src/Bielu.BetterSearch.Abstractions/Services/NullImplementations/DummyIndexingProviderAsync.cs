...
public class DummyIndexingProviderAsync : IIndexingProviderAsync
{
    ...
    public Task<Result<int>> IndexMultipleDocumentsAsync(IEnumerable<SearchDocument> documents, CancellationToken cancellationToken = default) => throw new NotImplementedException();
    ...
    public Task<Result<long?>> RemoveAllDocumentsAsync(DeleteAllDocumentsRequest index,
